...
class Vgg16():
    ...
    def create(self, dropout=0.5):
        ...
        # If we're trying a new dropout we need to adjust the weights of the model so that it sums to the same as the previous outputs
        if (dropout != 0.5):
